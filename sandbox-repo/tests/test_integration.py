...
from agent_sandbox.core.classifier import classify, classify_by_content, classify_by_path
...
class TestFileChangeDetection:
    ...
    def test_detect_new_file(self):
        from agent_sandbox.sandbox import diff_snapshots
...
class TestSandboxModule:
    ...
    def test_sandbox_informed_mode(self):
        from agent_sandbox.env_scanner import FileInfo, ScanManifest, Sensitivity
