"""Fix service_registry.json display_name and iam_prefix using Gemini.
...
1. The correct **IAM permission prefix** — this is the first segment of IAM
   ...
   Reference: https://cloud.google.com/iam/docs/permissions-reference
2. The correct **display name** — the official human-readable name used in
   GCP Console and documentation.
...
def main():
    ...
    fix_metadata(client, args.model, Path(args.registry), dry_run=args.dry_run)
